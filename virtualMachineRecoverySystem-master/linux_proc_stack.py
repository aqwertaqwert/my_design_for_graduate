...
#03.04
    print "linux_process_stack:{}",datetime.datetime.now()
#
...
#03.13     
        stacktime1=datetime.datetime.now()
        print "******************************  linux_process_stack calculate time1" ,stacktime1
...
#
        ...
        for p in linux_proc_info.linux_proc_info.calculate(self):
            #print "PPPPPPPPPPPPPPP",p  #p == <volatility.plugins.linux.linux_proc_info.process_info object at 0x7f24e3b54850>
            stats['tasks'] += 1
            if p:
...
#
        stacktime1=datetime.datetime.now()
        print "***********************************calculate stacltime1" ,stacktime1
    ...
    def analyze_stack(self, process_info, task, thread_number):
        ...
        """
        # shortcut variables
        print "!!!!!!!!!!!!!!!!!!!!!!__1",datetime.datetime.now()
        p = process_info
        i = thread_number
        ...
        if not is_thread and entry_point:
            ...
            if return_libc_start:
                ...
                #print "___________________________+++++++++++++++++++++++",datetime,datetime.now()
        ...
        if found_main:
            ...
            debug.info("Found main stackframestart1=datetime.datetime.now() at 0x{:016x}".format(stack_main))
...
#03.14
        print "!!!!!!!!!!!!!!!!!!!!!!__2",datetime.datetime.now()
#
    ...
    def calculate_annotations(self, frames):
        ...
        """
        print "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  calculate_annotations_1",datetime.datetime.now()
        ...
        print "calculate_annotations_2",datetime.datetime.now()
        return result
